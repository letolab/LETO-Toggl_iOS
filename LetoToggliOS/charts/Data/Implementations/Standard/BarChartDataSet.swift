...
public class BarChartDataSet: BarLineScatterCandleBubbleChartDataSet, IBarChartDataSet
{
    ...
    public var useStackedColors = false
    ...
    public var stackedColors = [[NSUIColor.blueColor(), NSUIColor.redColor()],[NSUIColor.redColor(), NSUIColor.blueColor()],[NSUIColor.greenColor(), NSUIColor.yellowColor()]]
    // MARK: - NSCopying
    ...
    public override func copyWithZone(zone: NSZone) -> AnyObject
    {
        ...
        copy.useStackedColors = useStackedColors
        return copy
    }
}